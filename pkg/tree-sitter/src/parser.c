...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 48:
      ...
      if (lookahead == '\r') ADVANCE(991);
      if (lookahead == '.' ||
          ('0' <= lookahead && lookahead <= '9')) ADVANCE(848);
      if (lookahead != 0) ADVANCE(50);
      END_STATE();
    case 49:
      if ((!eof && lookahead == 00)) ADVANCE(989);
    ...
    case 54:
      ...
      END_STATE();
    case 55:
      if ((!eof && lookahead == 00)) ADVANCE(984);
      if (lookahead == '\n') ADVANCE(983);
    ...
    case 106:
      ...
      END_STATE();
    case 107:
      if ((!eof && lookahead == 00)) ADVANCE(997);
      if (lookahead == '\n') ADVANCE(996);
    ...
    case 158:
      ...
      END_STATE();
    case 159:
      if ((!eof && lookahead == 00)) ADVANCE(999);
      if (lookahead == '\n') ADVANCE(996);
    ...
    case 160:
      ...
      END_STATE();
    case 161:
      if ((!eof && lookahead == 00)) ADVANCE(834);
      if (lookahead == '\n') ADVANCE(834);
    ...
    case 164:
      ...
      if (lookahead == '{') ADVANCE(938);
      if (set_contains(aux_sym__target_url_line_token1_character_set_1, 475, lookahead)) ADVANCE(852);
      if ((!eof && set_contains(aux_sym__target_url_line_token2_character_set_1, 484, lookahead))) ADVANCE(913);
      END_STATE();
    case 165:
    ...
    case 171:
      ...
      if (('1' <= lookahead && lookahead <= '5')) ADVANCE(806);
      if (lookahead == ' ' ||
          lookahead == 0xa0 ||
          lookahead == 0x1680 ||
          (0x2000 <= lookahead && lookahead <= 0x200a) ||
    ...
    case 808:
      ...
      if (lookahead == ' ' ||
          ...
          lookahead == 0x202f ||
          lookahead == 0x205f ||
          lookahead == 0x3000) ADVANCE(828);
      if (set_contains(aux_sym__target_url_line_token1_character_set_1, 475, lookahead)) ADVANCE(878);
    ...
    case 813:
      ...
      if (set_contains(aux_sym__target_url_line_token1_character_set_1, 475, lookahead)) ADVANCE(891);
    ...
    case 978:
      ...
      if ((!eof && lookahead == 00)) ADVANCE(961);
      if (lookahead != 0 &&
