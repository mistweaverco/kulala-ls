...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead != 0 &&
          lookahead != 0x2028 &&
          lookahead != 0x2029) ADVANCE(904);
      END_STATE();
    case 1:
      if ((!eof && lookahead == 00)) ADVANCE(980);
      if (lookahead == '\n') ADVANCE(979);
    ...
    case 49:
      ...
      END_STATE();
    case 50:
      if ((!eof && lookahead == 00)) ADVANCE(981);
      if (lookahead == '\n') ADVANCE(979);
    ...
    case 160:
      ...
      END_STATE();
    case 161:
      if ((!eof && lookahead == 00)) ADVANCE(924);
      if (lookahead == '\n') ADVANCE(942);
      if (lookahead == '\r') ADVANCE(942);
      if (lookahead == '\\') ADVANCE(932);
      if (lookahead == '{') ADVANCE(929);
      if (set_contains(aux_sym__target_url_line_token1_character_set_1, 475, lookahead)) ADVANCE(843);
      if ((!eof && set_contains(aux_sym__target_url_line_token2_character_set_1, 484, lookahead))) ADVANCE(904);
      END_STATE();
    case 162:
    ...
    case 167:
      ...
      if (lookahead == '$' ||
          ...
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z') ||
          (0xa1 <= lookahead && lookahead <= 0xffff)) ADVANCE(1029);
      END_STATE();
    case 168:
      ADVANCE_MAP(
        '\r', 831,
    ...
    case 804:
      ...
      if (set_contains(aux_sym__target_url_line_token1_character_set_1, 475, lookahead)) ADVANCE(869);
    ...
    case 807:
      ...
      if (set_contains(aux_sym__target_url_line_token1_character_set_1, 475, lookahead)) ADVANCE(856);
    ...
    case 809:
      ...
      if (set_contains(aux_sym__target_url_line_token1_character_set_1, 475, lookahead)) ADVANCE(882);
    ...
    case 885:
      ...
      if (lookahead == '-' ||
          ...
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1028);
      END_STATE();
    case 886:
      ACCEPT_TOKEN(aux_sym__target_url_line_token1);
      if (lookahead == 'A' ||
